...
class TaskController {
    ...
    public function processRequest(string $method, ?string $id): void {
        if ( $id === null ) {
            if ( $method === 'GET' ) {
                ...
                //gets data fom post request
                //if data is not passed from the client thus returns null
                //if it is null, we typecast to empty array
            ...
            switch ($method) {
                ...
                case 'DELETE':
                    ...
                    echo json_encode((["message" => "task deleted", "rows deleted" => $rows]));
                    break;
                default:
    ...
    private function respondUnprocessableEntity(array $errors) {
